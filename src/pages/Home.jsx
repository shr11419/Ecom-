        ...
        {banners.map((banner, index) => (
          ...
          >
            ...
            <div className="hero-content">
              {/* greeting shown on banner if logged in */}
              {user?.name && (
      ...
      <nav className="bottom-nav">
        ...
        <Link to="/wishlist" className={`bottom-nav-item ${location.pathname === "/wishlist" ? "active" : ""}`}>
          <div className="bottom-nav-icon-wrap">
            <FiHeart size={22} />
            {wishlistItems.length > 0 && <span className="bottom-badge">{wishlistItems.length}</span>}
          </div>
          <span>Wishlist</span>
        </Link>
        <Link to="/checkout" className={`bottom-nav-item ${location.pathname === "/checkout" ? "active" : ""}`}>
          <div className="bottom-nav-icon-wrap">
            ...
            {totalCartItems > 0 && <span className="bottom-badge">{totalCartItems}</span>}
          </div>
          <span>Cart</span>
        </Link>
